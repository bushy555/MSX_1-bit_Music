	...
	output "eshaker.rom"	; use for SJASMplus.  Remark for PASMO.
...
playTone:
	...
	xor  a
        out  ($aa),a
	ld   a,255
	out  ($aa),a		; Cassette Output becomes High
...
L03D6:	DEC	C	 ;(4)	; timing loop for duration of
	...
	in a,($aa)	;[11]	Cassette Output becomes Low
	jp .LP		;[10]

.HP:	out ($aa),a	;[11]	Cassette Output becomes High
	jp .LP		;[10]
.LP:
