...
;	output "1943.rom"		; Include this for SJASM assembler, exclude using PASMO assembler.
...
; ************************************************************************
BORDER_CLR:          EQU $0
message1:	DEFB	'MSX 1-bit music, using port $AA.     ',00
message2:       DEFB    'Ported to the MSX by /Bushy555.      ',00
message3:	DEFB	'HUBY music engine by Shiru.          ',00
message4:       DEFB	'Song: 1943.                          ',00

; *** DATA ***
MUSICDATA1:
                DEFW  $08A0               ; Initial tempo
